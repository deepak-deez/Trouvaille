...
export default function Footer() {
  return (
    <footer className="lg:px-[76px] px-[20px] py-[10px] mt-[90px] lg:py-[40px] flex flex-col gap-[50px]">
      <div className="flex flex-col social-media justify-center items-center gap-9">
        ...
        <ul className="flex flex-wrap gap-[24px] justify-center lg:gap-[48px]">
          ...
          <li>
            <img src={youtube} alt="social-media-icons" />
          </li>
          <li>
            <img src={apple} alt="social-media-icons" />
          </li>
          <li>
            <img src={pinterest} alt="social-media-icons" />
          </li>
        </ul>
      </div>
