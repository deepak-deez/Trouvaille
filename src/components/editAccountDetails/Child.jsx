    ...
    <header className="mt-[5rem] sm:mt-[8rem] lg:mt-[10rem] sm:mx-20 2xl:mx-[18.75rem]">
      ...
      <div className="mt-[5rem] xl:flex xl:justify-between xl:gap-14 lg:text-[20px]">
        <ul className="hidden xl:flex flex-col gap-10">
          ...
          <li className="grey-text"><Link to="/">Account Details</Link></li>
        ...
        <div className="edit-details flex flex-col lg:text-[22px]  p-5 lg:p-10 2xl:p-[2.2rem] rounded-2xl xl:w-[80%] backdrop-blur-sm">
          ...
          <input type="text" className="mb-[2.6rem] grey-text pl-[1.5rem] py-[0.88rem] rounded-2xl" value={'9064690593'}/>
          <h4 className="mb-[1.5rem]">Email ID</h4>
          <input type="text" className="mb-[3.1rem] grey-text pl-[1.5rem] py-[0.88rem] rounded-2xl" value='suresh@sample.com' />
          <h4 className="mb-[1.5rem]">Password</h4>
          <input type="text" className="mb-[3.1rem] grey-text pl-[1.5rem] py-[0.88rem] rounded-2xl" value='******'/>
          <h4 className="mb-[1.5rem]">Old Password</h4>
          <input type="text" className="mb-[3.1rem] grey-text pl-[1.5rem] py-[0.88rem] rounded-2xl"/>
