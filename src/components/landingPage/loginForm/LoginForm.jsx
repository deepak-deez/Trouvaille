...
const Header = () => {
  ...
  const [checked, setChecked] = useState((localStorage.getItem("rememberMe") === "true") ? true : false);
  // const [signedIn, setSignedIn] = useState(localStorage.getItem("signedIn")? true:false);
  useEffect(() => {
    if (userDetails) {
      // localStorage.setItem("signedIn", signedIn);
      handleRemember(userDetails)
      // setApiMessage(userDetails.message);
