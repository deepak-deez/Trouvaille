...
const Header = () => {
  return (
    <section className="flex flex-col login-form justify-center items-center">
      ...
      <div className="flex flex-col lg:w-[975px] w-[90%] md:px-[30px] md:py-[30px] mt-[15px] login-details px-[25px] py-[15px] lg:py-[67px] lg:px-[97px] justify-center">
          ...
          <div className=" input-fields lg:px-[39px] lg:py-[32px] px-[15px] py-[20px] lg:mt-[60px] mt-[30px] flex flex-row items-center justify-between">
            <input
              className="bg-transparent"
              type="text"
